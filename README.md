This project is a React application that displays a list of recent bank transactions. It includes features such as adding transactions, searching for transactions, and deleting transactions.
